...
| `enable_stable_pa_graph_inputs`     | bool | `False` | Skip per-layer PagedAttention task rebinding in FULL_DECODE_ONLY when graph input buffer addresses are stable. |
